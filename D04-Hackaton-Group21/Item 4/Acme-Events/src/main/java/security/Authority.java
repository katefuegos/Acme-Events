...
public class Authority implements GrantedAuthority {
	...
	public static final String PUBLICITER = "PUBLICITER";
	...
	@NotBlank
	@Pattern(regexp = "^" + Authority.ADMIN + "|" + Authority.CLIENT + "|"
			+ Authority.MANAGER + "|" + Authority.PUBLICITER + "$")
	@Override
	...
	public static Collection<Authority> listAuthorities() {
		...
		authority = new Authority();
		authority.setAuthority(Authority.PUBLICITER);
		result.add(authority);
