...
@Transactional
public class ManageEventServiceTest extends AbstractTest {
	...
	public void driverCreate() {
		...
		final Object testingData[][] = {
				 ...
				 * 92.4% d) analysis of data coverage - Se crea evento siendo
				 * manager1 para uno de sus clubes.
				 */
				{
				 ...
				 * - Se intenta crear un evento en un club de manager2 siendo
				 * manager1.
				 */
				{
				 ...
				 * un evento sin título siendo manager1.
				 */
				{
				 ...
				 * can create an event. c) analysis of sentence coverage: 92.4% d)
	...
	public void driverEdit() {
		...
		final Object testingData[][] = {
				 ...
				 * who follows the club where the event is organized.
				 * 
				 * - EDIT. b) POSITIVE TEST c) analysis of sentence coverage: 92.4%
				 * d) analysis of data coverage - Se edita un evento siendo
				 * manager1.
				 */
				 ...
				 * un evento de manager2 siendo manager1.
				 */
	...
	public void driverDelete() {
		...
		final Object testingData[][] = {
				 ...
				 * 90.1% d) analysis of data coverage - Se elimina un evento en draft mode siendo
				 * manager1.
				 */
				 ...
				 * coverage: 90.1% d) analysis of data coverage - Se intenta eliminar
				 * un evento en final mode.
				 */
	...
	protected void templateDeleteEvent(int eventId,
			final String username, final Class<?> expected) {
		Class<?> caught;
